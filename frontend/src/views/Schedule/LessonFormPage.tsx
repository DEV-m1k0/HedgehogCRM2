...
import { clientsApi, coursesApi, groupsApi, metaApi, scheduleApi } from '@/lib/api/crm';
                  ...
                  return (
                    ...
                    >
                      <div className="attendance-student">
                        <h3>
                          <Link href={`/clients/${item.client_id}`} className="attendance-student-link">
  ...
  return (
    <section className="lesson-form-page">
              ...
              {students.map((student) => {
                ...
                return (
                  <article className={`attendance-item attendance-item--${item.status}`} key={student.id}>
                    <div className="attendance-student">
                      <h3>
                        <Link href={`/clients/${student.id}`} className="attendance-student-link">
      ...
      <form id="lesson-form" className="lesson-form" onSubmit={handleSubmit}>
        ...
        <div className="lesson-form-actions lesson-form-actions--sticky">
          <button type="button" className="secondary" onClick={() => router.push('/calendar')} disabled={submitting}>
            Отмена
          </button>
          {isEditMode && (
            <button
