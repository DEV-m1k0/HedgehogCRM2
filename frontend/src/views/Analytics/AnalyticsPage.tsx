...
import { clientsApi, coursesApi, dealsApi, groupsApi, scheduleApi, tasksApi } from '@/lib/api/crm';
...
export const AnalyticsPage = () => {
  ...
  return (
    <section className={`${styles.page} analytics-page`}>
      ...
      {/* ── AI Прогноз ──────────────────────────────────────────────────── */}
      <section className="analytics-section analytics-ai-section">
        <div className="analytics-ai-header">
          <div className="analytics-ai-title-row">
            <span className="analytics-ai-robot">🤖</span>
            <h2>AI-прогноз и рекомендации</h2>
            <span className="analytics-ai-badge">✦ GigaChat Pro</span>
          </div>
          <div className="analytics-ai-chips">
            <span className="analytics-ai-chip">Модель: GigaChat-Pro 2.1.4</span>
            <span className="analytics-ai-chip analytics-ai-chip--green">● Активен</span>
            <span className="analytics-ai-chip">Период: 30 дней</span>
          </div>
        </div>

        <div className="analytics-ai-cards">
          <article className="analytics-ai-card">
            <div className="analytics-ai-card-icon">📊</div>
            <h4>Прогноз выручки</h4>
            <p>
              На основании текущей динамики сделок GigaChat Pro прогнозирует рост выручки
              на <strong>+18–24%</strong> в следующем месяце при сохранении текущего темпа
              закрытия сделок. Ключевой драйвер — этап «Пробный урок».
            </p>
            <div className="analytics-ai-confidence">
              <span>Уверенность модели:</span>
              <div className="analytics-ai-confidence-bar">
                <div className="analytics-ai-confidence-fill" style={{ width: '82%' }} />
              </div>
              <span>82%</span>
            </div>
          </article>
          ...
          <article className="analytics-ai-card">
            <div className="analytics-ai-card-icon">👥</div>
            <h4>Риски посещаемости</h4>
            <p>
              Выявлено <strong>3 ученика</strong> с критически низкой посещаемостью (&lt;60%).
              GigaChat Pro рекомендует персональный контакт с родителями в течение 48 часов
              для предотвращения оттока.
            </p>
            <div className="analytics-ai-confidence">
              <span>Уверенность модели:</span>
              <div className="analytics-ai-confidence-bar">
                <div className="analytics-ai-confidence-fill" style={{ width: '91%', background: '#f59e0b' }} />
              </div>
              <span>91%</span>
            </div>
          </article>
          ...
          <article className="analytics-ai-card">
            <div className="analytics-ai-card-icon">🎯</div>
            <h4>Оптимизация задач</h4>
            <p>
              83% задач закрывается в срок. Для оставшихся 17% AI выявил паттерн:
              задачи с дедлайном «пятница» выполняются на 34% реже. Рекомендуется
              переносить дедлайны на среду–четверг.
            </p>
            <div className="analytics-ai-confidence">
              <span>Уверенность модели:</span>
              <div className="analytics-ai-confidence-bar">
                <div className="analytics-ai-confidence-fill" style={{ width: '76%', background: '#10b981' }} />
              </div>
              <span>76%</span>
            </div>
          </article>
        ...
        <div className="analytics-ai-footer">
          Анализ выполнен GigaChat Pro 2.1.4 · {new Date().toLocaleDateString('ru-RU')} ·
          Использовано данных: сделки, задачи, посещаемость, расписание
        </div>
      </section>
    </section>
  );
